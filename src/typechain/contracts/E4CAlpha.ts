...
export interface E4CAlphaInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'batchMint', values: [PromiseOrValue<string>[]]): string
...
export interface E4CAlpha extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: E4CAlphaInterface
  ...
  callStatic: {
    ...
    batchMint(accounts: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>
