...
export interface TestTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'mint', values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>[]]): string
...
export interface TestToken extends BaseContract {
  ...
  callStatic: {
    ...
    mint(to: PromiseOrValue<string>, signature_: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>
    ...
    setMerkleRoot(merkleRoot_: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>
