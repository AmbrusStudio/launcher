...
export interface AmbrusStudioSalerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'whitelistSale', values: [PromiseOrValue<BytesLike>[]]): string
...
export interface AmbrusStudioSaler extends BaseContract {
  ...
  functions: {
    ...
    publicSale(overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
  ...
  populateTransaction: {
    ...
    boughtCount(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    publicSale(overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
