...
export interface AmbrusStudioBadgeInterface extends utils.Interface {
  functions: {
...
export interface AmbrusStudioBadge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: AmbrusStudioBadgeInterface
